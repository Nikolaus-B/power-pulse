...
import {Workout, Button, HeaderWrapper, Container, TitleWrapper, TitleText, InfoWrapper, Text, WorkoutContainer, DarkText} from './ExercisesItem.styled'
    ...
    return (
        <Container>
            <HeaderWrapper>
                ...
                <Button type="button" onClick={handleStartClick}> Start
            ...
            <InfoWrapper>
                <DarkText>Burned calories: <Text>{burnedCalories}</Text></DarkText>
                <DarkText>Body part: <Text>{bodyPart}</Text></DarkText>
                <DarkText>Target: <Text>{target}</Text></DarkText>
            </InfoWrapper>
        </Container>
    );
}