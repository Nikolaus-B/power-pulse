            ...
            <>
              ...
              <button>
                ...
                >
                  ...
                  />
                  <path
                    d="M23 15C24.0609 15 25.0783 15.4214 25.8284 16.1716C26.5786 16.9217 27 17.9391 27 19C27 20.0609 26.5786 21.0783 25.8284 21.8284C25.0783 22.5786 24.0609 23 23 23C21.9391 23 20.9217 22.5786 20.1716 21.8284C19.4214 21.0783 19 20.0609 19 19C19 17.9391 19.4214 16.9217 20.1716 16.1716C20.9217 15.4214 21.9391 15 23 15ZM23 31C23 31 31 31 31 29C31 26.6 27.1 24 23 24C18.9 24 15 26.6 15 29C15 31 23 31 23 31Z"
                    fill="#EFEDE8"
                    fill-opacity="0.1"
                  />
                </svg>
